...
if (document.querySelector('.reviews-page')) {
	let reviewsPage = new Swiper('.reviews-page__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
//filter========================================================================================================================================================
let blogItems = document.querySelectorAll('.catalog-page__column');
if (blogItems.length > 0) {
	let blogFilters = document.querySelectorAll('.catalog-page__filter');
	if (blogFilters.length > 0) {
		for (let index = 0; index < blogFilters.length; index++) {
			...
			blogFilter.addEventListener("click", function (e) {
				...
				const blogFilterActive = document.querySelector('.catalog-page__filter._active');
		...
		function showBlogItems(filter) {
			for (let index = 0; index < blogItems.length; index++) {
				...
				if (filter === 'all' || !filter) {
					...
					if (blogItem.classList.contains('catalog-page__column_' + filter)) {
						blogItem.classList.remove('_hide');
					}
				}
			}
